...
<!--[if lt IE 9]><script>document.createElement('audio');document.createElement('video');</script><![endif]-->
        <div class="wrap approveme-about-wrap">
            ...
            <div class="approveme-cta">
                ...
                <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms" class="hvr-float-shadow">Get My ApproveMe Plugin</a>
            </div>
            ...
            <div class="changelog feature-list">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p><a href="https://wordpress.org/plugins/wpform-forms/">1. WPForms</a><br> <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">2. WP E-Signature</a> <em>(ultimate, business or professional license)<br> </em><a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">3. E-Signature Advanced Add-Ons</a> <em>(included with the license above)<br> </em></p>
                        </div>

                        <div class="approveme-column-2">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-1.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">
                ...
                <div class="approveme-feature-section">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-2.jpg', __FILE__); ?>" class="esig-wpform-pic-border" width="100%"></p>
                            </div>
                        </div>
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>To download your license key you can log into your <a href="https://www.approveme.com/purchase-history?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">ApproveMe account here</a> (password was emailed with your receipt)</p>
                        </div>
                    </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <div class="approveme-btn">  <p class="esig-mini-btn"><a href="post-new.php?post_type=page" class="esig-mini-btn" target="_blank">Create a Blank Page Now</a></p></div>

                            <p>To learn about Stand Alone Documents you can visit this <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/faq/basic-document-vs-stand-alone-document/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms" target="_blank">helpful article</a></p>
                        </div>

                        <div class="approveme-column-2 approveme-center">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-3.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-4.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%"></p>
                            </div>
                        </div>
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>To learn more about Stand Alone Documents checkout the <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/stand-alone-documents-add-on/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">documentation page</a> for this add-on.</p>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2 approveme-center">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-5a.jpg', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">

                                    <img src="<?php echo plugins_url('../assets/images/wpform-add-on-5a-1.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">

                                    <img src="<?php echo plugins_url('../assets/images/wpform-add-on-5a-2.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-5a-3.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%"></p>
                            </div>
                        </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2 approveme-center">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-6.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/wpform-add-on-step-7.png', __FILE__); ?>" class="esig-wpform-pic-border" width="100%"></p>
                            </div>
                        </div>
                ...
                <h2>Still got questions? Login to your account at <br> <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">www.approveme.com</a></h2>
            </div>
        </div>
