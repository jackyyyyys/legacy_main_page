...
class WPSC_Metabox {
  ...
  public static function getMetaboxTokenArgs($show_social=true) {
    ...
    $args = [
      ...
      'forkdelta-link-desc' =>  __('Add Exchanges to your Block Explorer', 'wp-smart-contracts'),
  ...
  public function wpscSidebar() {
    ...
    echo $m->render(
      ...
      [
        ...
        'deploy_wpst' => __('How to deploy coins using <a href="https://wpsmartcontracts.com/wp-smart-tokens.php" target="_blank">WPST</a>?'),
        'deploy_wpst_vanilla' => 'tYPtSmCxgZg',
        'deploy_wpst_pistachio' => '2YMUZQdF-18',
        'deploy_wpst_chocolate' => 'Mt8AuL8PteU',
        'learn-more' => __('Learn More', 'wp-smart-contracts'),
